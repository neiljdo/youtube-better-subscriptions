function vidQuery() {
    if (isPolymer) {
        return "ytd-grid-video-renderer.style-scope.ytd-grid-renderer:not(." + HIDDEN_CLASS + "), ytd-rich-grid-video-renderer.style-scope.ytd-rich-item-renderer:not(." + HIDDEN_CLASS + "), ytd-item-renderer.style-scope.ytd-rich-grid-renderer:not(." + HIDDEN_CLASS + "), ytd-rich-grid-media.style-scope.ytd-rich-item-renderer:not(." + HIDDEN_CLASS + ")";
    } else {
